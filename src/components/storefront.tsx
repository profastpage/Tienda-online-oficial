    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      {scrollY > 400 && (
        <motion.button
          ...
          className="fixed bottom-6 left-6 z-40 w-12 h-12 bg-neutral-900 hover:bg-neutral-800 rounded-full flex items-center justify-center shadow-lg transition-colors"
        >
